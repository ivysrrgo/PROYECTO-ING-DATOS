...
BEGIN
    INSERT INTO Venta VALUES (p_docUsuario, p_docCliente, p_direccionEnv, p_fEntrega, p_fReparto, p_estadoVenta, p_precioEnv);
END //
DELIMITER ;
CALL RegistrarVenta(12345678, 11223344, 'Calle 45 #12-34', '2025-04-08', '2025-04-09', TRUE, 5000.00);
...
delimiter ;
call totalcomprascliente(92193950);
...
delimiter ;
select*from facturaventa;
call detallefacturacompleta(145);
...
select docusuario, nombreusuario, appellidousuario, correousuario, tipousuario from usuario
...
delimiter ;
call calcularsubtotalfactura(75);
